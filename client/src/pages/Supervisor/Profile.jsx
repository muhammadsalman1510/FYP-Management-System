...
/*
  ...
  TODO (Backend): GET /api/supervisor/profile — replace all hardcoded fields
...
const SupervisorProfile = () => {
  ...
  const storedName = localStorage.getItem('name') || 'Supervisor';

  const getInitials = (name) =>
    name.split(' ').map((n) => n[0]).join('').slice(0, 2).toUpperCase();

  // TODO (Backend): Replace hardcoded fields with GET /api/supervisor/profile
        ...
        <div className="col-12 col-xl-8">
            ...
            <div className="card-body p-4">
                ...
                <div className="d-flex flex-column align-items-center gap-2 flex-shrink-0">
                  ...
                  <div className="d-flex gap-2 flex-wrap justify-content-center">
                    ...
                    {photoFile && !photoSaved && (
                      <button className="btn btn-success btn-sm px-3" style={{ fontSize: '0.8rem' }} onClick={handlePhotoSave}>
                        Save Photo
                      </button>
                    )}
                  </div>
              ...
              <div className="row g-3">
                ...
                <div className="col-12 col-md-6">
                  ...
                  {editMode ? (
                    <input type="text" name="officeRoom" className="form-control" placeholder="e.g. Room 301, CS Block" value={draft.officeRoom} onChange={handleDraftChange} />
                  ) : (
                    <div className="form-control bg-light text-dark">{profile.officeRoom}</div>
                  )}
                </div>
                ...
                <div className="col-12 col-md-6">
                  ...
                  {editMode ? (
                    <input type="text" name="officeHours" className="form-control" placeholder="e.g. Mon-Wed: 10AM - 12PM" value={draft.officeHours} onChange={handleDraftChange} />
                  ) : (
                ...
                <div className="col-12">
                  ...
                  {editMode ? (
                    <input type="text" name="specialization" className="form-control" placeholder="e.g. Artificial Intelligence" value={draft.specialization} onChange={handleDraftChange} />
                  ) : (
                    <div className="form-control bg-light text-dark">{profile.specialization}</div>
                  )}
                </div>
              ...
              {editMode && (
                <div className="mt-4 d-flex gap-3">
                  <button className="btn btn-success px-5 fw-medium" onClick={handleProfileSave}>
                    Save Changes
                  </button>
          ...
          <div className="card shadow-sm border-0">
            ...
            <div className="card-body p-4">
              ...
              <div className="mt-4">
                <button className="btn btn-success px-5 fw-medium" onClick={handlePwSave}>
                  Update Password
                </button>
              </div>
