              ...
              <SidebarLinkGroup activeCondition={pathname.includes('/coordinator/accounts')}>
                {(handleClick, open) => (
                  <React.Fragment>
                    <button
                      type="button"
                      className={`d-flex align-items-center gap-2 rounded px-3 py-2 fw-medium sidebar-link position-relative w-100 border-0 bg-transparent text-start ${pathname.includes('/coordinator/accounts') ? 'sidebar-link-active' : ''}`}
              ...
              <SidebarLinkGroup activeCondition={pathname.includes('/coordinator/meetings')}>
                {(handleClick, open) => (
                  <React.Fragment>
                    <button
                      type="button"
                      className={`d-flex align-items-center gap-2 rounded px-3 py-2 fw-medium sidebar-link position-relative w-100 border-0 bg-transparent text-start ${pathname.includes('/coordinator/meetings') ? 'sidebar-link-active' : ''}`}
                      onClick={() => { sidebarExpanded ? handleClick() : setSidebarExpanded(true); }}
                    >
                      <svg width="18" height="18" viewBox="0 0 18 18" fill="currentColor">
