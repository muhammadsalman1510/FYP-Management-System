        ...
        <div className="flex-grow-1 overflow-auto no-scrollbar" style={{ overflowX: 'hidden' }}>
          <nav className="mt-3 px-3 pb-4">
            ...
            <ul className="list-unstyled d-flex flex-column gap-1 mb-0">
              ...
              {/* My Students */}
              <li>
                <NavLink to="/supervisor/students" onClick={handleNavClick}
                  className={`d-flex align-items-center gap-2 rounded px-3 py-2 fw-medium text-decoration-none sidebar-link ${pathname.includes('/supervisor/students') ? 'sidebar-link-active' : ''}`}>
                  <svg width="18" height="18" viewBox="0 0 18 18" fill="currentColor">
