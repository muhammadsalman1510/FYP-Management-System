  ...
  return (
    <ClickOutside onClick={() => setDropdownOpen(false)} className="position-relative">
      ...
      <Link
        ...
        to="#"
      >
        {/* Name and Role - hidden on small screens, visible on large */}
        <span className="d-none d-lg-block text-end">
          <span className="d-block small fw-medium text-dark">M.Salman</span>
          <span className="d-block text-muted" style={{ fontSize: '0.75rem' }}>Student</span>
        </span>
