  ...
  return (
    <ClickOutside onClick={() => setDropdownOpen(false)} className="position-relative">
      ...
      <Link
        ...
        to="#"
      >
        <span className="d-none d-lg-block text-end">
          <span className="d-block small fw-medium text-dark">{name}</span>
        ...
        >
          ...
          <ul className="list-unstyled border-bottom px-3 py-3 d-flex flex-column gap-3 mb-0">
            <li>
              <Link
                to={profilePath}
                className="d-flex align-items-center gap-2 text-decoration-none text-dark small fw-medium dropdown-item-custom"
